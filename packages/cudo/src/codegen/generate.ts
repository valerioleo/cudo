...
export interface GenerateOptions {
  ...
  /** Import specifier from a generated deployer file to the user's cudo config. */
  readonly configImport: string;
  /** The runtime package generated deployers import. Default "cudo". */
...
export const generate = (
  ...
  const packageName = opts.packageName ?? "cudo";
