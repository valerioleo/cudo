...
// The slice of a cudo deployment record this plugin needs. cudo writes the full
...
/**
 * Read a cudo `deployments/` folder into `@wagmi/cli` contracts. Records that share
...
/**
 * A `@wagmi/cli` plugin that sources contracts from a cudo `deployments/` folder.
 *
 * @example
 * ```ts
